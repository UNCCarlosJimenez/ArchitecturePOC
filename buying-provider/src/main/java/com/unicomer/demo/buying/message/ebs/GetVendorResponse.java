 ...
 *       &lt;sequence>
 *         &lt;element name="ResponseHeader" type="{http://ws.demo.unicomer.com/}responseHeader"/>
 *         &lt;element name="Vendor" type="{http://ws.demo.unicomer.com/}omcInterfaceVendor" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetVendorResponse {
    ...
    protected List<OmcInterfaceVendor> vendor;
     ...
     * 
     */
    public List<OmcInterfaceVendor> getVendor() {
        if (vendor == null) {
            vendor = new ArrayList<OmcInterfaceVendor>();
        }
        return this.vendor;
    }
